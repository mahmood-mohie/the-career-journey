...
const nextBtn = document.querySelector(".homeTestimonial__next");
const prevBtn = document.querySelector(".homeTestimonial__prev");
const dotsContainer = document.querySelector(".homeTestimonial__dotsContainer");
